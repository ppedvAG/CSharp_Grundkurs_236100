...
public class Person
{
	...
	/// <summary>
	/// Destruktor: Code der beim Einsammeln des GC ausgeführt wird
	/// </summary>
	~Person()
	{
	...
	public static int PersonenCounter { get; set; }

	public static void PrintCounter()
	{
        //Console.WriteLine(vorname); //Nicht möglich, da vorname sich immer auf ein Objekt bezieht (globale Member machen nichts mit Objekten)
        Console.WriteLine(PersonenCounter);
    }
}